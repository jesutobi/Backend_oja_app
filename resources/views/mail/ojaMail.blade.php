...
<![endif]-->
    <style type="text/css">
        ...
        [data-ogsb] .es-button.es-button-1714161582784 {
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    style="padding:0;Margin:0;font-size:0px"><img
                                                                        class="adapt-img"
                                                                        src="https://mxjtel.stripocdn.email/content/guids/CABINET_4b37022a140633341dde1058347a7d321843555e094a9c21ad47404cf57aa22a/images/oja_gYx.png"
                                                                        alt
                                                                        style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"
                                                                        height="150" width="459"></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                </tr>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="left" style="padding:10px;Margin:0">
                                                                    <h4
                                                                        style="Margin:0;line-height:18px;mso-line-height-rule:exactly;font-family:'courier new', courier, 'lucida sans typewriter', 'lucida typewriter', monospace;font-size:15px">
                                                                        Welcome {{ $data['user_data']->first_name }}
                                                                    </h4>
                                                                    <p
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        {{ config('app.name') }}! To complete
                                                                        your registration and gain full access to our
                                                                        services, please verify your email address by
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="left" style="padding:0;Margin:0"><a
                                                                        name="verify"
                                                                        style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#facc15;font-size:14px"></a>
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'courier new', courier, 'lucida sans typewriter', 'lucida typewriter', monospace;line-height:21px;color:#333333;font-size:14px">
                                                                        Please note that this link is valid for a
                                                                        limited time.</p>
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'courier new', courier, 'lucida sans typewriter', 'lucida typewriter', monospace;line-height:21px;color:#333333;font-size:14px">
                                                                        <br>
